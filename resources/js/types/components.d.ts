...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconMdiEmailSyncOutline: typeof import('~icons/mdi/email-sync-outline')['default']
    ...
    IconMdiShieldAccountOutline: typeof import('~icons/mdi/shield-account-outline')['default']
