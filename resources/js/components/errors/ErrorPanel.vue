...
<template>
    <div class="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16">
        <ErrorIllustration
            :variant="copy.illustration"
            class="w-36 max-w-full sm:w-44 lg:order-last lg:w-full lg:max-w-[320px] lg:justify-self-end"
        />
        ...
        <div>
            ...
            <h1
                class="text-brand-teal mt-8 text-3xl leading-[1.15] font-bold tracking-[-0.02em] text-balance sm:mt-10 sm:text-[2.6rem] sm:leading-[1.1]"
            >
                {{ copy.title }}
            </h1>
