        ...
        <div class="mx-auto max-w-7xl">
            <div class="bg-brand-teal relative overflow-hidden rounded-[24px] px-5 py-12 text-center sm:px-10 sm:py-14 lg:px-16 lg:py-20">
                <img
                    ...
                    alt=""
                    aria-hidden="true"
                    class="pointer-events-none absolute -top-16 -left-20 w-[360px] max-w-none opacity-25"
                />
                <img
                    src="/path-green.svg"
                    alt=""
                    aria-hidden="true"
                    class="pointer-events-none absolute -right-20 -bottom-16 w-[360px] max-w-none opacity-30"
                />

                <div class="relative mx-auto max-w-2xl">
                    <h2 class="text-3xl leading-tight font-bold tracking-[-0.02em] text-white sm:text-4xl lg:text-5xl">
                        Rückgabetermin im Kalender? Dann leg jetzt los.
                    </h2>
                    <p class="mt-5 text-base text-white/80 sm:text-lg">
                        Fahrzeug erfassen, Gutachten erhalten, Angebote vergleichen. Kostenlos und unverbindlich.
                    </p>
